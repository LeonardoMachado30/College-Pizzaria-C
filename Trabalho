/* 	
  ...
  ENGLISH---------
  CREATE A PROGRAM FOR A LOW CAPITAL PIZZERIA
  CONSIST OF 3 UNITS, EACH UNIT HAS A COMPUTER
  EACH COMPUTER IS CONNECTED ON THE INTERNET AND CONNECTING BETWEEN
  ONE OF THESE COMPUTERS WILL BE THE CENTRAL SERVER TO STORE DATA AT THE END OF THE DAY;
...
//Funcao gotoxz descarta o uso do \n ou \t e deixa o codigo mais dinamico
int FunGotoxy(){
	int opcao;
    opcao=0;
    L=9;
